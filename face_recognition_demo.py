...
class FrameProcessor:
    ...
    def process(self, frame):
        ...
        # print("ROIS ", rois) # rois is the number of faces detected in the current frame
        ...
        # print("face identities = ", face_identities) # id of face detected
...
def main():
    ...
    while True:
        ...
        if frame_num == 0:
            ...
            if args.output_resolution: # fails
